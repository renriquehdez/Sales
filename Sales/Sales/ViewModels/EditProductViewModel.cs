...
namespace Sales.ViewModels
{
    ...
    public class EditProductViewModel : BaseViewModel
    {
        ...
        private async void Save()
        {
            ...
            if (string.IsNullOrEmpty(this.Product.Price.ToString()))
            {
                await Application.Current.MainPage.DisplayAlert(
                   Languages.Error,
            ...
            var price = decimal.Parse(this.Product.Price.ToString());
            ...
            var oldProduct = productViewModel.MyProducts.Where(
